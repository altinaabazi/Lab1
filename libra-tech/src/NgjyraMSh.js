...
export class NgjyraMSh extends Component {
    constructor(props) {
        super(props);
    ...
    changeNgjyra = (e) => {
        this.setState({ Ngjyra: e.target.value });
    }
    ...
    deleteClick(id) {
        if (window.confirm('A jeni i sigurt?')) {
            fetch(variables.API_URL + 'NgjyraMSh/' + id, {
                method: 'DELETE',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
